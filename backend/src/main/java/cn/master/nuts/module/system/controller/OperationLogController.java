...
public class OperationLogController {
    ...
    public boolean remove(@PathVariable @Parameter(description="操作日志主键") String id) {
    ...
    public OperationLog getInfo(@PathVariable @Parameter(description="操作日志主键") String id) {
